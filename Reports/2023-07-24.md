...
* Working with image + command: 
    ...
    * In wandb: <img width="1430" alt="Screenshot 2023-07-26 at 2 33 39 PM" src="https://github.com/daisy-abbott/ARCSLab-reports/assets/112681549/d585afcf-36df-4230-8587-971241db6556">
    * Link to most recent code: https://github.com/daisy-abbott/ARCSLab-reports/blob/master/Assets/img-cmd-v1.py

# Issues: 
* pkl vs. pth
* change "data" to "model" for folder in wandb that contains the models
* 

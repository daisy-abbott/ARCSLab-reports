...
* Used Odlenborg Floor Plan to create a Model Key for Blender. 
    ...
    * mapped out width and length (not height) of oldy. Most walls are 8'. Using height of stairs we can estimate slopes but might be good to get the actual degree ? 

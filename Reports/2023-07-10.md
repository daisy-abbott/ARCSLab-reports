...
* What techniques should we apply to our work?
    * Creating the most realistic simulation environment possible: Implement wetness and cleanliness levels into our model. 
